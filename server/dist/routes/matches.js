    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
          _context.next = 3;
          return Match.find().populate('winners.playerId', 'name').sort({
            matchNumber: -1
          });
        case 3:
...
router.post('/', /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee2(req, res) {
    var session, winners, match, _iterator, _step, winner, player, totalMatches;
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          _context2.next = 2;
          return Match.startSession();
        case 2:
          session = _context2.sent;
          session.startTransaction();
          _context2.prev = 4;
          winners = req.body.winners; // Create new match
          _context2.t0 = Match;
          _context2.t1 = winners.map(function (winner) {
            return {
        ...
        case 10:
          ...
          _context2.t3 = _context2.t2 + 1;
          _context2.t4 = {
            winners: _context2.t1,
            matchNumber: _context2.t3
          };
          match = new _context2.t0(_context2.t4);
          _context2.next = 16;
          return match.save({
            session: session
          });
        case 16:
          // Update player stats
          _iterator = _createForOfIteratorHelper(winners);
          _context2.prev = 17;
          _iterator.s();
        case 19:
          ...
          winner = _step.value;
          _context2.next = 23;
          return Player.findById(winner.playerId);
        case 23:
        ...
        case 38:
          _context2.prev = 38;
          _context2.t5 = _context2["catch"](17);
    ...
    }, _callee2, null, [[4, 49, 54, 57], [17, 38, 41, 44]]);
  }));
